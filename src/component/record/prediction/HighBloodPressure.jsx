            ...
            if (prediction <= 30) {
                return (
                    <Alert severity="success">
                        ...
                        <br/> 현재의 건강한 생활 습관을 유지하면서, 끊임없이 자신을 돌보고, 건강 상태를 주기적으로 체크하는 것이 중요합니다. 당신의 건강한 라이프스타일이 앞으로도 계속해서 당신을 지켜줄 것입니다.
                    </Alert>
                );
                ...
                return (
                    <Alert severity="warning">
                        ...
                        <br/> 또한, 정기적인 건강 검진과 전문가의 조언을 구하는 것도 중요합니다. 혹시 이미 고혈압이나 다른 건강 문제가 있다면, 의사의 지시에 따라 약물 치료를 병행하는 것도 고려해야 할 수 있습니다.
