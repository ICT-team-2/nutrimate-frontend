const themeVariable = {
  lightMode: {
    'main-background': '#f8fbfa',
    'main-background-light': '#F8F9FB',
    'dark-background': '#eff1f3',
    'darker-background': '#202444',
    'white-background': '#FFFFFF',
    'general-background': '#F4F5F7',
    'brand-background': '#FFFFFF',
    'status-background': '#F8F9FB',
    'primary-background': '#0F4A15',
    'primary-transparent': 'rgba(207,237,200,0.38)',
    ...
    'menu-active': '#0F4A15',
    'menu-active-bg': 'rgba(207,237,200,0.38)',
    'menu-bg': 'rgba(207,237,200,0.17)',
    'scroll-bg': '#E3E6EF',
    'chat-bg': '#F4F5F7',
